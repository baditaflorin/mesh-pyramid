...
**Live → https://baditaflorin.github.io/mesh-pyramid/**

**Source → https://github.com/baditaflorin/mesh-pyramid**
...
git clone https://github.com/baditaflorin/mesh-pyramid
cd mesh-pyramid
npm install
npm run dev
```
...
- `mesh-pyramid:signalingUrl`
- `mesh-pyramid:turnTokenUrl`
- `mesh-pyramid:iceServers`
- `mesh-pyramid:room`
